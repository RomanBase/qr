 ...
 */
public class AnimatedExpandableListView extends ExpandableListView implements ExpandableListView.OnGroupClickListener {
    /*
    ...
    public boolean onGroupClick(ExpandableListView expandableListView, View view, int i, long l) {
        ...
        if (expandableListView.isGroupExpanded(i)) {
            ...
            if (previousGroup != -1 && justOne) {
                ((AnimatedExpandableListView) expandableListView).collapseGroupWithAnimation(previousGroup);
            }
            previousGroup = i;
        }
    ...
    public void setOnlyOneExpanded(boolean justOne) {
    ...
    public boolean collapseGroupWithAnimation(int groupPos) {
        ...
        if (adapter.getRealChildrenCount(groupPos) == 0) {
